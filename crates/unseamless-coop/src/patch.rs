...
/// opcode. Used by [`overwrite_landmark`] / [`nop_landmark`] to place the boot-flow code patches.
/// (`session_probe`'s hooks resolve their charted entries by fixed offset from the exe base instead,
/// not through this AOB path.)
